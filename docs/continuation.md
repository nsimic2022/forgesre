...
Both runs: **recorded after the double pytest on this branch** (see the PR / later edit of this file). Python 3.12, pytest 9.x. 1 warning (Starlette `httpx` / `starlette.testclient` deprecation — ignore).
