...
Both runs: **332 passed**, 1 warning (Starlette `httpx` / `starlette.testclient` deprecation — ignore), 41.34s then 40.68s. Python 3.12, pytest 9.x. Count recorded after the double run on `cursor/revert-llm-catalog-05f8`.
