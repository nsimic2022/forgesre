...
def format_board(rows: list[dict[str, Any]], *, color: bool | None = None, who: str = "") -> str:
    ...
    lines.append("Open one:  incidents <TAB>   or   incidents INC-0134_16.08.2026_09:13")
    lines.append("")
...
def format_history_rows(rows: list[dict[str, Any]], *, days: int = 90, total: int | None = None, color: bool | None = None) -> str:
    ...
    lines.append("")
    lines.append(f"{shown} match(es). Open one:  history <TAB>   or   incidents INC-0134_16.08.2026_09:13")
    return "\n".join(lines) + "\n"
