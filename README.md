...
| `/discovery` | **Save & scan** / **Scan now** fill + save **all connected** CIDRs (real prefixes, not `/24`-only) and queue a background probe / Approve / Ignore; **Sync NetBox** beside it (read-only, admin). Empty NetBox = yellow. |
